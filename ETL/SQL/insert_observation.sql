...
38000280,               -- Ask Erica  -- observation_type_concept_id,
cast(null as float),    -- Ask Erica  -- value_as_number,
cast(null as varchar),  -- Ask Erica  -- value_as_string,
0,                                    -- value_as_concept_id,
cast(null as integer),  -- Ask Erica  -- qualifier_concept_id,
cast(null as integer),  -- Ask Erica  -- unit_concept_id,
...
cast(null as varchar),  -- Ask Erica  -- unit_source_value,
cast(null as varchar)   -- Ask Erica  -- qualifier_source_value
from vocab_map vm
 join allergies a
