...
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.CONCEPT  (
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.VOCABULARY  (
  VOCABULARY_ID			    VARCHAR(20)		NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.DOMAIN  (
  DOMAIN_ID			    VARCHAR(20)		NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.CONCEPT_CLASS  (
  CONCEPT_CLASS_ID			    VARCHAR(20)		NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.CONCEPT_RELATIONSHIP  (
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.RELATIONSHIP  (
  RELATIONSHIP_ID			    VARCHAR(20)		NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.CONCEPT_SYNONYM  (
  CONCEPT_ID			    INTEGER			NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.CONCEPT_ANCESTOR  (
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.SOURCE_TO_CONCEPT_MAP  (
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.DRUG_STRENGTH  (
...
INSERT INTO cdm_synthea_v897.tester.METADATA (METADATA_CONCEPT_ID, METADATA_TYPE_CONCEPT_ID, NAME, VALUE_AS_STRING, VALUE_AS_CONCEPT_ID, METADATA_DATE, METADATA_DATETIME) 
...
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.SURVEY_CONDUCT  (
...
--HINT DISTRIBUTE ON RANDOM
IF XACT_STATE() = 1 COMMIT; IF XACT_STATE() = 1 COMMIT; CREATE TABLE  cdm_synthea_v897.tester.LOCATION_HISTORY  (
