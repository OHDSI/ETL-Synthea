...
CREATE TABLE cdm_synthea_v53.CONCEPT  (CONCEPT_ID			    INTEGER			  NOT NULL ,
...
CREATE TABLE cdm_synthea_v53.VOCABULARY  (VOCABULARY_ID			    VARCHAR(20)		NOT NULL,
...
CREATE TABLE cdm_synthea_v53.DOMAIN  (DOMAIN_ID			    VARCHAR(20)		NOT NULL,
...
CREATE TABLE cdm_synthea_v53.CONCEPT_CLASS  (CONCEPT_CLASS_ID			    VARCHAR(20)		NOT NULL,
...
CREATE TABLE cdm_synthea_v53.CONCEPT_RELATIONSHIP  (CONCEPT_ID_1			INTEGER			NOT NULL,
...
CREATE TABLE cdm_synthea_v53.RELATIONSHIP  (RELATIONSHIP_ID			    VARCHAR(20)		NOT NULL,
...
CREATE TABLE cdm_synthea_v53.CONCEPT_SYNONYM  (CONCEPT_ID			      INTEGER			  NOT NULL,
...
CREATE TABLE cdm_synthea_v53.CONCEPT_ANCESTOR  (ANCESTOR_CONCEPT_ID		    INTEGER		NOT NULL,
...
CREATE TABLE cdm_synthea_v53.SOURCE_TO_CONCEPT_MAP  (SOURCE_CODE				      VARCHAR(50)		NOT NULL,
...
CREATE TABLE cdm_synthea_v53.DRUG_STRENGTH  (DRUG_CONCEPT_ID				      INTEGER		  NOT NULL,
...
CREATE TABLE cdm_synthea_v53.COHORT_DEFINITION  (COHORT_DEFINITION_ID				    INTEGER			  NOT NULL,
...
CREATE TABLE cdm_synthea_v53.ATTRIBUTE_DEFINITION  (ATTRIBUTE_DEFINITION_ID		  INTEGER			  NOT NULL,
...
--HINT DISTRIBUTE_ON_KEY(PERSON_ID) 
CREATE TABLE cdm_synthea_v53.DEATH
 (PERSON_ID							  INTEGER			NOT NULL ,
...
CREATE TABLE cdm_synthea_v53.COHORT
...
--HINT DISTRIBUTE_ON_KEY(SUBJECT_ID) 
CREATE TABLE cdm_synthea_v53.COHORT_ATTRIBUTE
 (COHORT_DEFINITION_ID		INTEGER		NOT NULL ,
  SUBJECT_ID						  INTEGER		NOT NULL ,
  COHORT_START_DATE				DATE			NOT NULL ,
  COHORT_END_DATE				  DATE			NOT NULL ,
