#' @title Create Non-Vocabulary CDM Tables.
#'
#' @description This function creates OMOP CDM tables, excluding vocabulary tables.
#'
#' @usage CreateEventTables(connectionDetails,cdmDatabaseSchema)
#'
...
CreateEventTables <- function (connectionDetails, cdmDatabaseSchema)
{


    pathToSql <- base::system.file("sql/sql_server", package = "ETLSyntheaBuilder")

    sqlFile <- base::paste0(pathToSql, "/", "create_event_tables.sql")
    ...
    writeLines("Running create_event_tables.sql")
